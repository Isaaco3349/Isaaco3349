...
🔵 PolyPulse — Real-time Polymarket analytics dashboard built with Next.js 16 and Tailwind CSS
...
- **Web3:** Base, Redbelly Network, Coinbase AgentKit, Neynar, ERC-8021, ethers.js
- **Compliance & Identity:** Verifiable Credentials, zkSNARK identity layers, W3C VC data model
- **Smart Contracts:** Hardhat, EVM (Prague), Solidity 0.8.30
- **AI:** Claude, LangChain, LangGraph
- **Tools:** Next.js, Express, React, GitHub Actions
